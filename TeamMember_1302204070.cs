...
{
    class TeamMembers_1302204070
    {
        public TeamMember[] members { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal6_2_1302204070.json";

            string jsonString = File.ReadAllText(fileName);
            TeamMembers_1302204034 jsonData = JsonSerializer.Deserialize<TeamMembers_1302204034>(jsonString);
