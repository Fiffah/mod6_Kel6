...
{
    class GlossaryItem_1302204070
    {
        public GlossaryClass glossary { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal6_3_13022000027.json";

            string jsonString = File.ReadAllText(fileName);
            GlossaryItem_1302204070 jsonData = JsonSerializer.Deserialize<GlossaryItem_13022004070>(jsonString);
