...
{
    class GlossaryItem_1302200121
    {
        public GlossaryClass glossary { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal6_3_1302200121.json";

            string jsonString = File.ReadAllText(fileName);
            GlossaryItem_1302200121 jsonData = JsonSerializer.Deserialize<GlossaryItem_1302200121>(jsonString);
