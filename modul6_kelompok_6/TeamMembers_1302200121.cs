...
{
    class TeamMembers_1302200121
    {
        public TeamMember[] members { get; set; }

        public void ReadJSON()
        {
            string fileName = "jurnal6_2_1302200121.json";

            string jsonString = File.ReadAllText(fileName);
            TeamMembers_1302200121 jsonData = JsonSerializer.Deserialize<TeamMembers_1302200121>(jsonString);
